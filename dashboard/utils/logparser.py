...
class LogAnalyser:
    ...
    def machine_details(job_file_name):
        ...
        :return:
        """
        machine_data = Common.validation_param_detail("machine_detail.yaml",
                                                     "machine_detail")
    ...
    def regex_information_extractor(job_file_name, command):
        ...
        failed_test_cases_information = os.popen('zless {}/{}|{}'.format(
            Common.get_config_value("data_location"), job_file_name, command)).readlines()
        return failed_test_cases_information
    ...
    def suspicious_message_extractor(job_file_name):
        ...
        """
        suspicious_messages = {}
        filename = "{}/{}".format(Common.get_config_value("data_location"), job_file_name)
